...
<html lang="es">
    ...
    <body>
        ...
        <div id="main">
            <!--nav class="navbar bg-light navbar-light fixed-top" style="color: #005689; padding-bottom: 0; padding-top: 0; font-family: raleway">
                <div class="clearfix">
                    <div class="float-left">
                        <span class="menuicon" onclick="openNav()" style="text-align: center; font-size: 30px; padding-left: 15px;">☰</span>
                        <a class="navbar-brand" href="#">&nbsp&nbsp&nbsp<img src="asset/images/sniglet.png" width="7%" alt="RockJS Framework"></a>
                    </div>
                </div>

                <div class="media float-right" style="color: #222 !important;">
                     <i>Focus On Services</span>&nbsp&nbsp&nbsp
                    <span style="padding-top: 17px;" class="pe-7s-bell" title="Setings"></i>&nbsp&nbsp&nbsp
                    <span style="padding-top: 17px;" class="pe-7s-settings" title="Setings"></span>&nbsp&nbsp&nbsp
                    <span style="padding-top: 17px;" class="pe-7s-info" title="Info"></span>&nbsp&nbsp&nbsp
                    <img src="asset/images/img_avatar3.png" alt="John Doe" class="mr-3 mt-3 rounded-circle" style="width:30px;">
                </div>



            </nav-->
            <!--nav class="navbar navbar-expand-sm bg-light fixed-top" style="color: #005689 !important; padding-bottom: 0; padding-top: 0;"-->
