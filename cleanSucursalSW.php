...
<div class="container">
    <h4>Sucursal</h4>
    <p>
        Esta pagina invoca al SW de caltalogo de Sucursal y procesa su contenido
...
<script>
    function myFunction() {
        ...
        xhttp.onreadystatechange = function () {
            if (this.readyState == 4 && this.status == 200) {
                ...
                $.ajax({
                    ...
                    data: "dataArray=" + array2 + "&fileName=Sucursal",
                    success: function (text) {
                        if (text == "success") {
                            document.getElementById("demo").innerHTML = '<div class="alert alert-success"><strong>Succes!</strong> Se cargo correctamete <a href="json/Sucursal.json" target="_blank" class="alert-link">See more</a></div>';
                        } else {
        ...
        xhttp.open("GET", "http://focus.acceso.crescloud.com/cgi-bwp/BI2/Menu/FocusLab/Berna/SWSucursal_fc.bwp", true);
        xhttp.send();
