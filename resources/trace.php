...
class trace {
    ...
    public function __construct() {
        ...
        //echo $someJSON;
        $nombre_archivo = 'C:/xampp/htdocs/Kreswin/resources/trace.json';
        $contenido = $someJSON;
        try {
            ...
            if (is_writable($nombre_archivo)) {
                ...
                $NewJsonHistory = fopen("C:/xampp/htdocs/Kreswin/resources/trace.json", "w") or die("Unable to open file!");
        ...
        try {
             ...
             */
            $text_replace = fopen("C:/xampp/htdocs/Kreswin/resources/trace.json", "r") or die("Unable to open file!");
            $jsonoriginal = fread($text_replace, filesize("C:/xampp/htdocs/Kreswin/resources/trace.json"));
            fclose($text_replace);
            //Lee el texto y reemplaza ][ por ,
            $resultado = str_replace("}][{", "},{", $jsonoriginal, $contador);
            $replaceJsonParse = fopen("C:/xampp/htdocs/Kreswin/resources/trace.json", "w") or die("Unable to open file!");
